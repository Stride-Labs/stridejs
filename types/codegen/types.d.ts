/**
* This file and any referenced files were automatically generated by @cosmology/telescope@1.11.18
...
export declare type ProtoMsg = Omit<Any, "typeUrl"> & {
    typeUrl: any;
};
...
export declare type TelescopeGeneratedType<T = unknown, SDK = unknown, Amino = unknown> = TelescopeGeneratedCodec<T, SDK, Amino>;
export declare type GeneratedType = TelescopeGeneratedCodec;
/**
...
export declare type EncodeObject = Message<any>;
