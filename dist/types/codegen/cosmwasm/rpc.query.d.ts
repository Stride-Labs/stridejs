    ...
    cosmwasm: {
        wasm: {
            v1: {
                ...
                codeInfo(request: import("./wasm/v1/query").QueryCodeInfoRequest): Promise<import("./wasm/v1/query").QueryCodeInfoResponse>;
                ...
                wasmLimitsConfig(request?: import("./wasm/v1/query").QueryWasmLimitsConfigRequest): Promise<import("./wasm/v1/query").QueryWasmLimitsConfigResponse>;
