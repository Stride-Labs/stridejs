...
const MsgOverwriteDelegationRecord = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.delegationRecord !== void 0) {
      import_stakedym.DelegationRecord.encode(message.delegationRecord, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.delegationRecord = import_stakedym.DelegationRecord.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseMsgOverwriteDelegationRecord();
    message.creator = object.creator ?? "";
    message.delegationRecord = object.delegationRecord !== void 0 && object.delegationRecord !== null ? import_stakedym.DelegationRecord.fromPartial(object.delegationRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgOverwriteDelegationRecord();
    ...
    if (object.delegation_record !== void 0 && object.delegation_record !== null) {
      message.delegationRecord = import_stakedym.DelegationRecord.fromAmino(object.delegation_record);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.creator = message.creator === "" ? void 0 : message.creator;
    obj.delegation_record = message.delegationRecord ? import_stakedym.DelegationRecord.toAmino(message.delegationRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgOverwriteUnbondingRecord = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.unbondingRecord !== void 0) {
      import_stakedym.UnbondingRecord.encode(message.unbondingRecord, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.unbondingRecord = import_stakedym.UnbondingRecord.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseMsgOverwriteUnbondingRecord();
    message.creator = object.creator ?? "";
    message.unbondingRecord = object.unbondingRecord !== void 0 && object.unbondingRecord !== null ? import_stakedym.UnbondingRecord.fromPartial(object.unbondingRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgOverwriteUnbondingRecord();
    ...
    if (object.unbonding_record !== void 0 && object.unbonding_record !== null) {
      message.unbondingRecord = import_stakedym.UnbondingRecord.fromAmino(object.unbonding_record);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.creator = message.creator === "" ? void 0 : message.creator;
    obj.unbonding_record = message.unbondingRecord ? import_stakedym.UnbondingRecord.toAmino(message.unbondingRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgOverwriteRedemptionRecord = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.redemptionRecord !== void 0) {
      import_stakedym.RedemptionRecord.encode(message.redemptionRecord, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
