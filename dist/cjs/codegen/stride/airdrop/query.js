...
__export(query_exports, {
  QueryAirdropRequest: () => QueryAirdropRequest,
  QueryAirdropResponse: () => QueryAirdropResponse,
  QueryAllAirdropsRequest: () => QueryAllAirdropsRequest,
  QueryAllAirdropsResponse: () => QueryAllAirdropsResponse,
  QueryAllAllocationsRequest: () => QueryAllAllocationsRequest,
  QueryAllAllocationsResponse: () => QueryAllAllocationsResponse,
  QueryUserAllocationRequest: () => QueryUserAllocationRequest,
  QueryUserAllocationResponse: () => QueryUserAllocationResponse,
  QueryUserAllocationsRequest: () => QueryUserAllocationsRequest,
  QueryUserAllocationsResponse: () => QueryUserAllocationsResponse,
  QueryUserSummaryRequest: () => QueryUserSummaryRequest,
  QueryUserSummaryResponse: () => QueryUserSummaryResponse
});
...
const QueryAllAirdropsResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.airdrops) {
      import_airdrop.Airdrop.encode(v, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
const QueryUserAllocationResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.userAllocation !== void 0) {
      import_airdrop.UserAllocation.encode(message.userAllocation, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.userAllocation = import_airdrop.UserAllocation.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryUserAllocationResponse();
    message.userAllocation = object.userAllocation !== void 0 && object.userAllocation !== null ? import_airdrop.UserAllocation.fromPartial(object.userAllocation) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryUserAllocationResponse();
    if (object.user_allocation !== void 0 && object.user_allocation !== null) {
      message.userAllocation = import_airdrop.UserAllocation.fromAmino(object.user_allocation);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.user_allocation = message.userAllocation ? import_airdrop.UserAllocation.toAmino(message.userAllocation) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryUserAllocationsResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.userAllocations) {
      import_airdrop.UserAllocation.encode(v, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
const QueryAllAllocationsResponse = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.allocations.push(import_airdrop.UserAllocation.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromPartial(object) {
    const message = createBaseQueryAllAllocationsResponse();
    message.allocations = object.allocations?.map((e) => import_airdrop.UserAllocation.fromPartial(e)) || [];
  ...
  fromAmino(object) {
    const message = createBaseQueryAllAllocationsResponse();
    message.allocations = object.allocations?.map((e) => import_airdrop.UserAllocation.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
  ...
  toAmino(message) {
    ...
    if (message.allocations) {
      obj.allocations = message.allocations.map((e) => e ? import_airdrop.UserAllocation.toAmino(e) : void 0);
    } else {
