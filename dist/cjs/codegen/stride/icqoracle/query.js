...
const TokenPriceResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.spotPrice !== "") {
      writer.uint32(90).string(import_math.Decimal.fromUserInput(message.spotPrice, 18).atomics);
    }
    if (message.lastRequestTime !== void 0) {
      import_timestamp.Timestamp.encode((0, import_helpers.toTimestamp)(message.lastRequestTime), writer.uint32(98).fork()).ldelim();
    }
    if (message.lastResponseTime !== void 0) {
      import_timestamp.Timestamp.encode((0, import_helpers.toTimestamp)(message.lastResponseTime), writer.uint32(106).fork()).ldelim();
    }
