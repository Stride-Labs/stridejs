...
__export(query_exports, {
  QueryAllDepositRecordRequest: () => QueryAllDepositRecordRequest,
  QueryAllDepositRecordResponse: () => QueryAllDepositRecordResponse,
  QueryAllEpochUnbondingRecordRequest: () => QueryAllEpochUnbondingRecordRequest,
  QueryAllEpochUnbondingRecordResponse: () => QueryAllEpochUnbondingRecordResponse,
  QueryAllUserRedemptionRecordForUserRequest: () => QueryAllUserRedemptionRecordForUserRequest,
  QueryAllUserRedemptionRecordForUserResponse: () => QueryAllUserRedemptionRecordForUserResponse,
  QueryAllUserRedemptionRecordRequest: () => QueryAllUserRedemptionRecordRequest,
  QueryAllUserRedemptionRecordResponse: () => QueryAllUserRedemptionRecordResponse,
  QueryDepositRecordByHostRequest: () => QueryDepositRecordByHostRequest,
  QueryDepositRecordByHostResponse: () => QueryDepositRecordByHostResponse,
  QueryGetDepositRecordRequest: () => QueryGetDepositRecordRequest,
  QueryGetDepositRecordResponse: () => QueryGetDepositRecordResponse,
  QueryGetEpochUnbondingRecordRequest: () => QueryGetEpochUnbondingRecordRequest,
  QueryGetEpochUnbondingRecordResponse: () => QueryGetEpochUnbondingRecordResponse,
  QueryGetUserRedemptionRecordRequest: () => QueryGetUserRedemptionRecordRequest,
  QueryGetUserRedemptionRecordResponse: () => QueryGetUserRedemptionRecordResponse,
  QueryLSMDepositRequest: () => QueryLSMDepositRequest,
  QueryLSMDepositResponse: () => QueryLSMDepositResponse,
  QueryLSMDepositsRequest: () => QueryLSMDepositsRequest,
  QueryLSMDepositsResponse: () => QueryLSMDepositsResponse,
...
function createBaseQueryGetDepositRecordResponse() {
  return {
    depositRecord: import_records.DepositRecord.fromPartial({})
  };
}
const QueryGetDepositRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.depositRecord !== void 0) {
      import_records.DepositRecord.encode(message.depositRecord, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.depositRecord = import_records.DepositRecord.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryGetDepositRecordResponse();
    message.depositRecord = object.depositRecord !== void 0 && object.depositRecord !== null ? import_records.DepositRecord.fromPartial(object.depositRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryGetDepositRecordResponse();
    if (object.deposit_record !== void 0 && object.deposit_record !== null) {
      message.depositRecord = import_records.DepositRecord.fromAmino(object.deposit_record);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.deposit_record = message.depositRecord ? import_records.DepositRecord.toAmino(message.depositRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryAllDepositRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.depositRecord) {
      import_records.DepositRecord.encode(v, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== void 0) {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.depositRecord.push(import_records.DepositRecord.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromPartial(object) {
    const message = createBaseQueryAllDepositRecordResponse();
    message.depositRecord = object.depositRecord?.map((e) => import_records.DepositRecord.fromPartial(e)) || [];
  ...
  fromAmino(object) {
    const message = createBaseQueryAllDepositRecordResponse();
    message.depositRecord = object.deposit_record?.map((e) => import_records.DepositRecord.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
  ...
  toAmino(message) {
    ...
    if (message.depositRecord) {
      obj.deposit_record = message.depositRecord.map((e) => e ? import_records.DepositRecord.toAmino(e) : void 0);
    } else {
...
function createBaseQueryGetUserRedemptionRecordResponse() {
  return {
    userRedemptionRecord: import_records.UserRedemptionRecord.fromPartial({})
  };
}
const QueryGetUserRedemptionRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.userRedemptionRecord !== void 0) {
      import_records.UserRedemptionRecord.encode(message.userRedemptionRecord, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.userRedemptionRecord = import_records.UserRedemptionRecord.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryGetUserRedemptionRecordResponse();
    message.userRedemptionRecord = object.userRedemptionRecord !== void 0 && object.userRedemptionRecord !== null ? import_records.UserRedemptionRecord.fromPartial(object.userRedemptionRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryGetUserRedemptionRecordResponse();
    if (object.user_redemption_record !== void 0 && object.user_redemption_record !== null) {
      message.userRedemptionRecord = import_records.UserRedemptionRecord.fromAmino(object.user_redemption_record);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.user_redemption_record = message.userRedemptionRecord ? import_records.UserRedemptionRecord.toAmino(message.userRedemptionRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryAllUserRedemptionRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.userRedemptionRecord) {
      import_records.UserRedemptionRecord.encode(v, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== void 0) {
      import_pagination.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.userRedemptionRecord.push(import_records.UserRedemptionRecord.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = import_pagination.PageResponse.decode(reader, reader.uint32());
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryAllUserRedemptionRecordResponse();
    message.userRedemptionRecord = object.userRedemptionRecord?.map((e) => import_records.UserRedemptionRecord.fromPartial(e)) || [];
    message.pagination = object.pagination !== void 0 && object.pagination !== null ? import_pagination.PageResponse.fromPartial(object.pagination) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryAllUserRedemptionRecordResponse();
    message.userRedemptionRecord = object.user_redemption_record?.map((e) => import_records.UserRedemptionRecord.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
      message.pagination = import_pagination.PageResponse.fromAmino(object.pagination);
    }
    return message;
  ...
  toAmino(message) {
    ...
    if (message.userRedemptionRecord) {
      obj.user_redemption_record = message.userRedemptionRecord.map((e) => e ? import_records.UserRedemptionRecord.toAmino(e) : void 0);
    } else {
...
const QueryAllUserRedemptionRecordForUserRequest = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.pagination !== void 0) {
      import_pagination.PageRequest.encode(message.pagination, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
function createBaseQueryGetEpochUnbondingRecordResponse() {
  return {
    epochUnbondingRecord: import_records.EpochUnbondingRecord.fromPartial({})
  };
}
const QueryGetEpochUnbondingRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.epochUnbondingRecord !== void 0) {
      import_records.EpochUnbondingRecord.encode(message.epochUnbondingRecord, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.epochUnbondingRecord = import_records.EpochUnbondingRecord.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryGetEpochUnbondingRecordResponse();
    message.epochUnbondingRecord = object.epochUnbondingRecord !== void 0 && object.epochUnbondingRecord !== null ? import_records.EpochUnbondingRecord.fromPartial(object.epochUnbondingRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryGetEpochUnbondingRecordResponse();
    if (object.epoch_unbonding_record !== void 0 && object.epoch_unbonding_record !== null) {
      message.epochUnbondingRecord = import_records.EpochUnbondingRecord.fromAmino(object.epoch_unbonding_record);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.epoch_unbonding_record = message.epochUnbondingRecord ? import_records.EpochUnbondingRecord.toAmino(message.epochUnbondingRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryAllEpochUnbondingRecordResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.epochUnbondingRecord) {
      import_records.EpochUnbondingRecord.encode(v, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== void 0) {
      import_pagination.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.epochUnbondingRecord.push(import_records.EpochUnbondingRecord.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = import_pagination.PageResponse.decode(reader, reader.uint32());
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryAllEpochUnbondingRecordResponse();
    message.epochUnbondingRecord = object.epochUnbondingRecord?.map((e) => import_records.EpochUnbondingRecord.fromPartial(e)) || [];
    message.pagination = object.pagination !== void 0 && object.pagination !== null ? import_pagination.PageResponse.fromPartial(object.pagination) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryAllEpochUnbondingRecordResponse();
    message.epochUnbondingRecord = object.epoch_unbonding_record?.map((e) => import_records.EpochUnbondingRecord.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
      message.pagination = import_pagination.PageResponse.fromAmino(object.pagination);
    }
    return message;
  ...
  toAmino(message) {
    ...
    if (message.epochUnbondingRecord) {
      obj.epoch_unbonding_record = message.epochUnbondingRecord.map((e) => e ? import_records.EpochUnbondingRecord.toAmino(e) : void 0);
    } else {
...
function createBaseQueryLSMDepositResponse() {
  return {
    deposit: import_records.LSMTokenDeposit.fromPartial({})
  };
}
...
const QueryLSMDepositsResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.deposits) {
      import_records.LSMTokenDeposit.encode(v, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.deposits.push(import_records.LSMTokenDeposit.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryLSMDepositsResponse();
    message.deposits = object.deposits?.map((e) => import_records.LSMTokenDeposit.fromPartial(e)) || [];
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryLSMDepositsResponse();
    message.deposits = object.deposits?.map((e) => import_records.LSMTokenDeposit.fromAmino(e)) || [];
    return message;
  },
  toAmino(message) {
    const obj = {};
    if (message.deposits) {
      obj.deposits = message.deposits.map((e) => e ? import_records.LSMTokenDeposit.toAmino(e) : void 0);
    } else {
