...
var tx_exports = {};
__export(tx_exports, {
  MsgAddOracle: () => MsgAddOracle,
  MsgAddOracleResponse: () => MsgAddOracleResponse,
  MsgInstantiateOracle: () => MsgInstantiateOracle,
  MsgInstantiateOracleResponse: () => MsgInstantiateOracleResponse,
  MsgRemoveOracle: () => MsgRemoveOracle,
  MsgRemoveOracleResponse: () => MsgRemoveOracleResponse,
  MsgRestoreOracleICA: () => MsgRestoreOracleICA,
  MsgRestoreOracleICAResponse: () => MsgRestoreOracleICAResponse,
  MsgToggleOracle: () => MsgToggleOracle,
  MsgToggleOracleResponse: () => MsgToggleOracleResponse
});
