...
__export(types_exports, {
  ...
  EvidenceTypeAmino: () => EvidenceTypeAmino,
  ...
  evidenceTypeFromJSON: () => evidenceTypeFromJSON,
  evidenceTypeToJSON: () => evidenceTypeToJSON,
...
const RequestInitChain = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.time !== void 0) {
      import_timestamp.Timestamp.encode((0, import_helpers.toTimestamp)(message.time), writer.uint32(10).fork()).ldelim();
    }
    if (message.chainId !== "") {
  ...
  fromAmino(object) {
    ...
    if (object.app_state_bytes !== void 0 && object.app_state_bytes !== null) {
      message.appStateBytes = (0, import_helpers.bytesFromBase64)(object.app_state_bytes);
    }
...
const RequestApplySnapshotChunk = {
  ...
  fromAmino(object) {
    ...
    if (object.chunk !== void 0 && object.chunk !== null) {
      message.chunk = (0, import_helpers.bytesFromBase64)(object.chunk);
    }
  ...
  toAmino(message) {
    ...
    obj.chunk = message.chunk ? (0, import_helpers.base64FromBytes)(message.chunk) : void 0;
...
const ResponseInfo = {
  ...
  fromAmino(object) {
    ...
    if (object.last_block_app_hash !== void 0 && object.last_block_app_hash !== null) {
      message.lastBlockAppHash = (0, import_helpers.bytesFromBase64)(object.last_block_app_hash);
    }
    return message;
  },
  toAmino(message) {
...
const ResponseQuery = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.proofOps !== void 0) {
      import_proof.ProofOps.encode(message.proofOps, writer.uint32(66).fork()).ldelim();
    }
    if (message.height !== BigInt(0)) {
...
const ConsensusParams = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.evidence !== void 0) {
      import_params.EvidenceParams.encode(message.evidence, writer.uint32(18).fork()).ldelim();
    }
    if (message.validator !== void 0) {
      import_params.ValidatorParams.encode(message.validator, writer.uint32(26).fork()).ldelim();
    }
    if (message.version !== void 0) {
      import_params.VersionParams.encode(message.version, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.version = import_params.VersionParams.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    ...
    message.version = object.version !== void 0 && object.version !== null ? import_params.VersionParams.fromPartial(object.version) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseConsensusParams();
    ...
    if (object.version !== void 0 && object.version !== null) {
      message.version = import_params.VersionParams.fromAmino(object.version);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.version = message.version ? import_params.VersionParams.toAmino(message.version) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const Snapshot = {
  ...
  fromAmino(object) {
    ...
    if (object.metadata !== void 0 && object.metadata !== null) {
      message.metadata = (0, import_helpers.bytesFromBase64)(object.metadata);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.hash = message.hash ? (0, import_helpers.base64FromBytes)(message.hash) : void 0;
    obj.metadata = message.metadata ? (0, import_helpers.base64FromBytes)(message.metadata) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
