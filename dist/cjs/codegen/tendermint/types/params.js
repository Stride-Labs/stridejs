...
function createBaseEvidenceParams() {
  return {
    ...
    maxAgeDuration: import_duration.Duration.fromPartial({}),
    maxBytes: BigInt(0)
  };
}
const EvidenceParams = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.maxAgeDuration !== void 0) {
      import_duration.Duration.encode(message.maxAgeDuration, writer.uint32(18).fork()).ldelim();
    }
    if (message.maxBytes !== BigInt(0)) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.maxAgeDuration = import_duration.Duration.decode(reader, reader.uint32());
          break;
        case 3:
          message.maxBytes = reader.int64();
          break;
  ...
  fromPartial(object) {
    ...
    message.maxAgeDuration = object.maxAgeDuration !== void 0 && object.maxAgeDuration !== null ? import_duration.Duration.fromPartial(object.maxAgeDuration) : void 0;
    message.maxBytes = object.maxBytes !== void 0 && object.maxBytes !== null ? BigInt(object.maxBytes.toString()) : BigInt(0);
    return message;
  },
  fromAmino(object) {
    ...
    if (object.max_age_duration !== void 0 && object.max_age_duration !== null) {
      message.maxAgeDuration = import_duration.Duration.fromAmino(object.max_age_duration);
    }
    if (object.max_bytes !== void 0 && object.max_bytes !== null) {
      message.maxBytes = BigInt(object.max_bytes);
    }
  ...
  toAmino(message) {
    ...
    obj.max_age_duration = message.maxAgeDuration ? import_duration.Duration.toAmino(message.maxAgeDuration) : void 0;
    obj.max_bytes = message.maxBytes !== BigInt(0) ? message.maxBytes?.toString() : void 0;
    return obj;
  },
  fromAminoMsg(object) {
