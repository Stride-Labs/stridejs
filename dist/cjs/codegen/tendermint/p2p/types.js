...
const DefaultNodeInfo = {
  ...
  fromAmino(object) {
    ...
    if (object.channels !== void 0 && object.channels !== null) {
      message.channels = (0, import_helpers.bytesFromBase64)(object.channels);
    }
  ...
  toAmino(message) {
    ...
    obj.channels = message.channels ? (0, import_helpers.base64FromBytes)(message.channels) : void 0;
