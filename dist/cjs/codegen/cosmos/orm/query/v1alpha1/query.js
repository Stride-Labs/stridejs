...
const GetResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.result !== void 0) {
      import_any.Any.encode(message.result, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.result = import_any.Any.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseGetResponse();
    message.result = object.result !== void 0 && object.result !== null ? import_any.Any.fromPartial(object.result) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseGetResponse();
    if (object.result !== void 0 && object.result !== null) {
      message.result = import_any.Any.fromAmino(object.result);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.result = message.result ? import_any.Any.toAmino(message.result) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const ListResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.pagination !== void 0) {
      import_pagination.PageResponse.encode(message.pagination, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.results.push(import_any.Any.decode(reader, reader.uint32()));
          break;
        case 5:
  ...
  fromPartial(object) {
    const message = createBaseListResponse();
    message.results = object.results?.map((e) => import_any.Any.fromPartial(e)) || [];
  ...
  fromAmino(object) {
    const message = createBaseListResponse();
    message.results = object.results?.map((e) => import_any.Any.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
  ...
  toAmino(message) {
    const obj = {};
    if (message.results) {
      obj.results = message.results.map((e) => e ? import_any.Any.toAmino(e) : void 0);
    } else {
...
const IndexValue = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.timestamp !== void 0) {
      import_timestamp.Timestamp.encode((0, import_helpers.toTimestamp)(message.timestamp), writer.uint32(58).fork()).ldelim();
    }
    if (message.duration !== void 0) {
      import_duration.Duration.encode(message.duration, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
