...
const Params = {
  ...
  toAmino(message) {
    const obj = {};
    obj.community_tax = message.communityTax === "" ? void 0 : import_math.Decimal.fromUserInput(message.communityTax, 18).atomics;
    obj.base_proposer_reward = message.baseProposerReward === "" ? void 0 : import_math.Decimal.fromUserInput(message.baseProposerReward, 18).atomics;
    obj.bonus_proposer_reward = message.bonusProposerReward === "" ? void 0 : import_math.Decimal.fromUserInput(message.bonusProposerReward, 18).atomics;
...
const ValidatorSlashEvent = {
  ...
  toAmino(message) {
    ...
    obj.fraction = message.fraction === "" ? void 0 : import_math.Decimal.fromUserInput(message.fraction, 18).atomics;
    return obj;
  },
  fromAminoMsg(object) {
...
const DelegatorStartingInfo = {
  ...
  toAmino(message) {
    ...
    obj.stake = message.stake === "" ? void 0 : import_math.Decimal.fromUserInput(message.stake, 18).atomics;
