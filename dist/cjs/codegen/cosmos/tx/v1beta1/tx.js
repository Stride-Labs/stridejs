...
const TxRaw = {
  ...
  fromAmino(object) {
    ...
    if (object.body_bytes !== void 0 && object.body_bytes !== null) {
      message.bodyBytes = (0, import_helpers.bytesFromBase64)(object.body_bytes);
    }
    if (object.auth_info_bytes !== void 0 && object.auth_info_bytes !== null) {
      message.authInfoBytes = (0, import_helpers.bytesFromBase64)(object.auth_info_bytes);
    }
    message.signatures = object.signatures?.map((e) => (0, import_helpers.bytesFromBase64)(e)) || [];
    return message;
  },
...
const SignDocDirectAux = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.publicKey !== void 0) {
      import_any.Any.encode(message.publicKey, writer.uint32(18).fork()).ldelim();
    }
    if (message.chainId !== "") {
      writer.uint32(26).string(message.chainId);
    }
...
const TxBody = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    for (const v of message.extensionOptions) {
      import_any.Any.encode(v, writer.uint32(8186).fork()).ldelim();
    }
    for (const v of message.nonCriticalExtensionOptions) {
      import_any.Any.encode(v, writer.uint32(16378).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 1023:
          message.extensionOptions.push(import_any.Any.decode(reader, reader.uint32()));
          break;
        case 2047:
          message.nonCriticalExtensionOptions.push(import_any.Any.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    ...
    message.extensionOptions = object.extensionOptions?.map((e) => import_any.Any.fromPartial(e)) || [];
    message.nonCriticalExtensionOptions = object.nonCriticalExtensionOptions?.map((e) => import_any.Any.fromPartial(e)) || [];
    return message;
  },
  fromAmino(object) {
    const message = createBaseTxBody();
    ...
    message.extensionOptions = object.extension_options?.map((e) => import_any.Any.fromAmino(e)) || [];
    message.nonCriticalExtensionOptions = object.non_critical_extension_options?.map((e) => import_any.Any.fromAmino(e)) || [];
    return message;
  },
  toAmino(message) {
    const obj = {};
    ...
    if (message.nonCriticalExtensionOptions) {
      obj.non_critical_extension_options = message.nonCriticalExtensionOptions.map((e) => e ? import_any.Any.toAmino(e) : void 0);
    } else {
...
const AuxSignerData = {
  ...
  fromAmino(object) {
    ...
    if (object.sig !== void 0 && object.sig !== null) {
      message.sig = (0, import_helpers.bytesFromBase64)(object.sig);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.mode = message.mode === 0 ? void 0 : message.mode;
    obj.sig = message.sig ? (0, import_helpers.base64FromBytes)(message.sig) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
