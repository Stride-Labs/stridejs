...
const DecCoin = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.amount !== "") {
      writer.uint32(18).string(import_decimals.Decimal.fromUserInput(message.amount, 18).atomics);
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.amount = import_decimals.Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
const DecProto = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.dec !== "") {
      writer.uint32(10).string(import_decimals.Decimal.fromUserInput(message.dec, 18).atomics);
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.dec = import_decimals.Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
