...
const PrivKey = {
  ...
  fromAmino(object) {
    const message = createBasePrivKey();
    if (object.secret !== void 0 && object.secret !== null) {
      message.secret = (0, import_helpers.bytesFromBase64)(object.secret);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.secret = message.secret ? (0, import_helpers.base64FromBytes)(message.secret) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
