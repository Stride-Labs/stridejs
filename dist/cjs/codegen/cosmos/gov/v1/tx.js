...
const MsgCancelProposalResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.canceledTime !== void 0) {
      import_timestamp.Timestamp.encode((0, import_helpers.toTimestamp)(message.canceledTime), writer.uint32(18).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.canceledTime = (0, import_helpers.fromTimestamp)(import_timestamp.Timestamp.decode(reader, reader.uint32()));
          break;
        case 3:
  ...
  fromAmino(object) {
    ...
    if (object.canceled_time !== void 0 && object.canceled_time !== null) {
      message.canceledTime = (0, import_helpers.fromTimestamp)(import_timestamp.Timestamp.fromAmino(object.canceled_time));
    }
  ...
  toAmino(message) {
    const obj = {};
    obj.proposal_id = message.proposalId ? message.proposalId?.toString() : "0";
    obj.canceled_time = message.canceledTime ? import_timestamp.Timestamp.toAmino((0, import_helpers.toTimestamp)(message.canceledTime)) : void 0;
