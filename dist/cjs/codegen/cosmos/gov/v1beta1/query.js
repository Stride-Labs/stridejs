...
function createBaseQueryProposalResponse() {
  return {
    proposal: import_gov.Proposal.fromPartial({})
  };
}
...
function createBaseQueryVoteResponse() {
  return {
    vote: import_gov.Vote.fromPartial({})
  };
}
...
function createBaseQueryDepositResponse() {
  return {
    deposit: import_gov.Deposit.fromPartial({})
  };
}
...
function createBaseQueryTallyResultResponse() {
  return {
    tally: import_gov.TallyResult.fromPartial({})
  };
}
