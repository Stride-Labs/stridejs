...
0 && (module.exports = {
  ...
  FieldDescriptorProto_Label,
  FieldDescriptorProto_LabelAmino,
  FieldDescriptorProto_LabelSDKType,
  FieldDescriptorProto_Type,
  FieldDescriptorProto_TypeAmino,
  FieldDescriptorProto_TypeSDKType,
  FieldOptions,
  FieldOptions_CType,
  FieldOptions_CTypeAmino,
  FieldOptions_CTypeSDKType,
  FieldOptions_JSType,
  FieldOptions_JSTypeAmino,
  FieldOptions_JSTypeSDKType,
  FileDescriptorProto,
  FileDescriptorSet,
  FileOptions,
  FileOptions_OptimizeMode,
  FileOptions_OptimizeModeAmino,
  ...
  MethodOptions,
  MethodOptions_IdempotencyLevel,
  MethodOptions_IdempotencyLevelAmino,
  MethodOptions_IdempotencyLevelSDKType,
