...
const OsmosisTwapRecord = {
  ...
  toAmino(message) {
    ...
    obj.p0_last_spot_price = message.p0LastSpotPrice === "" ? void 0 : import_math.Decimal.fromUserInput(message.p0LastSpotPrice, 18).atomics;
    obj.p1_last_spot_price = message.p1LastSpotPrice === "" ? void 0 : import_math.Decimal.fromUserInput(message.p1LastSpotPrice, 18).atomics;
    obj.p0_arithmetic_twap_accumulator = message.p0ArithmeticTwapAccumulator === "" ? void 0 : import_math.Decimal.fromUserInput(message.p0ArithmeticTwapAccumulator, 18).atomics;
    obj.p1_arithmetic_twap_accumulator = message.p1ArithmeticTwapAccumulator === "" ? void 0 : import_math.Decimal.fromUserInput(message.p1ArithmeticTwapAccumulator, 18).atomics;
    obj.geometric_twap_accumulator = message.geometricTwapAccumulator === "" ? void 0 : import_math.Decimal.fromUserInput(message.geometricTwapAccumulator, 18).atomics;
