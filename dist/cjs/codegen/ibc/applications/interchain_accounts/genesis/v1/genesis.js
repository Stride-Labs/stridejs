...
var import_controller = require("../../controller/v1/controller");
var import_host = require("../../host/v1/host");
...
function createBaseControllerGenesisState() {
  return {
    ...
    interchainAccounts: [],
    ports: [],
    params: import_controller.Params.fromPartial({})
  };
}
const ControllerGenesisState = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.params !== void 0) {
      import_controller.Params.encode(message.params, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
function createBaseHostGenesisState() {
  return {
    ...
    interchainAccounts: [],
    port: "",
    params: import_host.Params.fromPartial({})
  };
}
const HostGenesisState = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.params !== void 0) {
      import_host.Params.encode(message.params, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
