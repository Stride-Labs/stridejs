...
function createBaseMsgPayPacketFee() {
  return {
    fee: import_fee.Fee.fromPartial({}),
    sourcePortId: "",
    sourceChannelId: "",
    signer: "",
    relayers: []
...
const MsgPayPacketFee = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.fee !== void 0) {
      import_fee.Fee.encode(message.fee, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.fee = import_fee.Fee.decode(reader, reader.uint32());
          break;
        case 2:
  ...
  fromPartial(object) {
    const message = createBaseMsgPayPacketFee();
    message.fee = object.fee !== void 0 && object.fee !== null ? import_fee.Fee.fromPartial(object.fee) : void 0;
  ...
  fromAmino(object) {
    ...
    if (object.fee !== void 0 && object.fee !== null) {
      message.fee = import_fee.Fee.fromAmino(object.fee);
    }
...
function createBaseMsgPayPacketFeeAsync() {
  return {
    ...
    packetFee: import_fee.PacketFee.fromPartial({})
  };
}
const MsgPayPacketFeeAsync = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.packetFee !== void 0) {
      import_fee.PacketFee.encode(message.packetFee, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.packetFee = import_fee.PacketFee.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    ...
    message.packetFee = object.packetFee !== void 0 && object.packetFee !== null ? import_fee.PacketFee.fromPartial(object.packetFee) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgPayPacketFeeAsync();
    ...
    if (object.packet_fee !== void 0 && object.packet_fee !== null) {
      message.packetFee = import_fee.PacketFee.fromAmino(object.packet_fee);
    }
    return message;
  },
  toAmino(message) {
