...
class MsgClientImpl {
  ...
  registerPayee(request) {
    const data = import_tx.MsgRegisterPayee.encode(request).finish();
    const promise = this.rpc.request("ibc.applications.fee.v1.Msg", "RegisterPayee", data);
    return promise.then((data2) => import_tx.MsgRegisterPayeeResponse.decode(new import_binary.BinaryReader(data2)));
  }
  registerCounterpartyPayee(request) {
    const data = import_tx.MsgRegisterCounterpartyPayee.encode(request).finish();
    const promise = this.rpc.request("ibc.applications.fee.v1.Msg", "RegisterCounterpartyPayee", data);
    return promise.then((data2) => import_tx.MsgRegisterCounterpartyPayeeResponse.decode(new import_binary.BinaryReader(data2)));
  }
  payPacketFee(request) {
    const data = import_tx.MsgPayPacketFee.encode(request).finish();
    const promise = this.rpc.request("ibc.applications.fee.v1.Msg", "PayPacketFee", data);
    return promise.then((data2) => import_tx.MsgPayPacketFeeResponse.decode(new import_binary.BinaryReader(data2)));
  }
  payPacketFeeAsync(request) {
    const data = import_tx.MsgPayPacketFeeAsync.encode(request).finish();
    const promise = this.rpc.request("ibc.applications.fee.v1.Msg", "PayPacketFeeAsync", data);
    return promise.then((data2) => import_tx.MsgPayPacketFeeAsyncResponse.decode(new import_binary.BinaryReader(data2)));
  }
}
