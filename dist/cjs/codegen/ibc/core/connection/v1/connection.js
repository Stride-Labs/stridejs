...
function createBaseCounterparty() {
  return {
    clientId: "",
    connectionId: "",
    prefix: import_commitment.MerklePrefix.fromPartial({})
  };
}
const Counterparty = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.prefix !== void 0) {
      import_commitment.MerklePrefix.encode(message.prefix, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.prefix = import_commitment.MerklePrefix.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    ...
    message.prefix = object.prefix !== void 0 && object.prefix !== null ? import_commitment.MerklePrefix.fromPartial(object.prefix) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseCounterparty();
    ...
    if (object.prefix !== void 0 && object.prefix !== null) {
      message.prefix = import_commitment.MerklePrefix.fromAmino(object.prefix);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.prefix = message.prefix ? import_commitment.MerklePrefix.toAmino(message.prefix) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
