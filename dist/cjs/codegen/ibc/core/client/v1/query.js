...
const QueryClientStatesResponse = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.clientStates.push(import_client.IdentifiedClientState.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromPartial(object) {
    const message = createBaseQueryClientStatesResponse();
    message.clientStates = object.clientStates?.map((e) => import_client.IdentifiedClientState.fromPartial(e)) || [];
  ...
  fromAmino(object) {
    const message = createBaseQueryClientStatesResponse();
    message.clientStates = object.client_states?.map((e) => import_client.IdentifiedClientState.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
  ...
  toAmino(message) {
    ...
    if (message.clientStates) {
      obj.client_states = message.clientStates.map((e) => e ? import_client.IdentifiedClientState.toAmino(e) : void 0);
    } else {
...
const QueryConsensusStatesResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.consensusStates) {
      import_client.ConsensusStateWithHeight.encode(v, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== void 0) {
      import_pagination.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.consensusStates.push(import_client.ConsensusStateWithHeight.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = import_pagination.PageResponse.decode(reader, reader.uint32());
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryConsensusStatesResponse();
    message.consensusStates = object.consensusStates?.map((e) => import_client.ConsensusStateWithHeight.fromPartial(e)) || [];
    message.pagination = object.pagination !== void 0 && object.pagination !== null ? import_pagination.PageResponse.fromPartial(object.pagination) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryConsensusStatesResponse();
    message.consensusStates = object.consensus_states?.map((e) => import_client.ConsensusStateWithHeight.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
      message.pagination = import_pagination.PageResponse.fromAmino(object.pagination);
    }
    return message;
  ...
  toAmino(message) {
    ...
    if (message.consensusStates) {
      obj.consensus_states = message.consensusStates.map((e) => e ? import_client.ConsensusStateWithHeight.toAmino(e) : void 0);
    } else {
...
const QueryConsensusStateHeightsResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    for (const v of message.consensusStateHeights) {
      import_client.Height.encode(v, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== void 0) {
      import_pagination.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.consensusStateHeights.push(import_client.Height.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = import_pagination.PageResponse.decode(reader, reader.uint32());
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryConsensusStateHeightsResponse();
    message.consensusStateHeights = object.consensusStateHeights?.map((e) => import_client.Height.fromPartial(e)) || [];
    message.pagination = object.pagination !== void 0 && object.pagination !== null ? import_pagination.PageResponse.fromPartial(object.pagination) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryConsensusStateHeightsResponse();
    message.consensusStateHeights = object.consensus_state_heights?.map((e) => import_client.Height.fromAmino(e)) || [];
    if (object.pagination !== void 0 && object.pagination !== null) {
      message.pagination = import_pagination.PageResponse.fromAmino(object.pagination);
    }
    return message;
  ...
  toAmino(message) {
    ...
    if (message.consensusStateHeights) {
      obj.consensus_state_heights = message.consensusStateHeights.map((e) => e ? import_client.Height.toAmino(e) : void 0);
    } else {
...
const QueryUpgradedClientStateResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.upgradedClientState !== void 0) {
      import_any.Any.encode(message.upgradedClientState, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
const QueryUpgradedConsensusStateResponse = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    if (message.upgradedConsensusState !== void 0) {
      import_any.Any.encode(message.upgradedConsensusState, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.upgradedConsensusState = import_any.Any.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseQueryUpgradedConsensusStateResponse();
    message.upgradedConsensusState = object.upgradedConsensusState !== void 0 && object.upgradedConsensusState !== null ? import_any.Any.fromPartial(object.upgradedConsensusState) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryUpgradedConsensusStateResponse();
    if (object.upgraded_consensus_state !== void 0 && object.upgraded_consensus_state !== null) {
      message.upgradedConsensusState = import_any.Any.fromAmino(object.upgraded_consensus_state);
    }
    return message;
  },
  toAmino(message) {
    const obj = {};
    obj.upgraded_consensus_state = message.upgradedConsensusState ? import_any.Any.toAmino(message.upgradedConsensusState) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
