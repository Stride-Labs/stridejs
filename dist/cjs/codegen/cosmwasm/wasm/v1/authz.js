...
__export(authz_exports, {
  ...
  Cosmwasm_wasmv1ContractAuthzFilterX_FromAmino: () => Cosmwasm_wasmv1ContractAuthzFilterX_FromAmino,
  Cosmwasm_wasmv1ContractAuthzFilterX_InterfaceDecoder: () => Cosmwasm_wasmv1ContractAuthzFilterX_InterfaceDecoder,
  Cosmwasm_wasmv1ContractAuthzFilterX_ToAmino: () => Cosmwasm_wasmv1ContractAuthzFilterX_ToAmino,
  Cosmwasm_wasmv1ContractAuthzLimitX_FromAmino: () => Cosmwasm_wasmv1ContractAuthzLimitX_FromAmino,
  Cosmwasm_wasmv1ContractAuthzLimitX_InterfaceDecoder: () => Cosmwasm_wasmv1ContractAuthzLimitX_InterfaceDecoder,
  Cosmwasm_wasmv1ContractAuthzLimitX_ToAmino: () => Cosmwasm_wasmv1ContractAuthzLimitX_ToAmino,
...
const ContractGrant = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.limit !== void 0) {
      import_any.Any.encode(message.limit, writer.uint32(18).fork()).ldelim();
    }
    if (message.filter !== void 0) {
      import_any.Any.encode(message.filter, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
  ...
  fromPartial(object) {
    ...
    message.limit = object.limit !== void 0 && object.limit !== null ? import_any.Any.fromPartial(object.limit) : void 0;
    message.filter = object.filter !== void 0 && object.filter !== null ? import_any.Any.fromPartial(object.filter) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseContractGrant();
...
const MaxFundsLimit = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.amounts.push(import_coin.Coin.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    const message = createBaseMaxFundsLimit();
    message.amounts = object.amounts?.map((e) => import_coin.Coin.fromPartial(e)) || [];
    return message;
  },
  fromAmino(object) {
    const message = createBaseMaxFundsLimit();
    message.amounts = object.amounts?.map((e) => import_coin.Coin.fromAmino(e)) || [];
    return message;
  },
  toAmino(message) {
    const obj = {};
    if (message.amounts) {
      obj.amounts = message.amounts.map((e) => e ? import_coin.Coin.toAmino(e) : void 0);
    } else {
...
const AcceptedMessagesFilter = {
  ...
  fromAmino(object) {
    const message = createBaseAcceptedMessagesFilter();
    message.messages = object.messages?.map((e) => (0, import_encoding.toUtf8)(JSON.stringify(e))) || [];
    return message;
  },
  toAmino(message) {
    const obj = {};
    if (message.messages) {
      obj.messages = message.messages.map((e) => JSON.parse((0, import_encoding.fromUtf8)(e)));
    } else {
