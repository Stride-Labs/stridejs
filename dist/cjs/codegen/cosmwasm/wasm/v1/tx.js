...
const MsgExecuteContract = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    for (const v of message.funds) {
      import_coin.Coin.encode(v, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
const MsgUpdateInstantiateConfig = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.newInstantiatePermission !== void 0) {
      import_types.AccessConfig.encode(message.newInstantiatePermission, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.newInstantiatePermission = import_types.AccessConfig.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object) {
    ...
    message.sender = object.sender ?? "";
    message.codeId = object.codeId !== void 0 && object.codeId !== null ? BigInt(object.codeId.toString()) : BigInt(0);
    message.newInstantiatePermission = object.newInstantiatePermission !== void 0 && object.newInstantiatePermission !== null ? import_types.AccessConfig.fromPartial(object.newInstantiatePermission) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgUpdateInstantiateConfig();
    ...
    if (object.new_instantiate_permission !== void 0 && object.new_instantiate_permission !== null) {
      message.newInstantiatePermission = import_types.AccessConfig.fromAmino(object.new_instantiate_permission);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.sender = message.sender === "" ? void 0 : message.sender;
    obj.code_id = message.codeId !== BigInt(0) ? message.codeId?.toString() : void 0;
    obj.new_instantiate_permission = message.newInstantiatePermission ? import_types.AccessConfig.toAmino(message.newInstantiatePermission) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgUpdateParams = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.params !== void 0) {
      import_types.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
...
const MsgStoreAndInstantiateContract = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.instantiatePermission !== void 0) {
      import_types.AccessConfig.encode(message.instantiatePermission, writer.uint32(34).fork()).ldelim();
    }
    ...
    for (const v of message.funds) {
      import_coin.Coin.encode(v, writer.uint32(74).fork()).ldelim();
    }
    if (message.source !== "") {
...
const MsgStoreAndMigrateContract = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.instantiatePermission !== void 0) {
      import_types.AccessConfig.encode(message.instantiatePermission, writer.uint32(26).fork()).ldelim();
    }
    if (message.contract !== "") {
