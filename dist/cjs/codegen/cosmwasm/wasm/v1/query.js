...
const QueryBuildAddressRequest = {
  ...
  fromAmino(object) {
    ...
    if (object.init_args !== void 0 && object.init_args !== null) {
      message.initArgs = (0, import_helpers.bytesFromBase64)(object.init_args);
    }
    return message;
  },
  toAmino(message) {
    ...
    obj.init_args = message.initArgs ? (0, import_helpers.base64FromBytes)(message.initArgs) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
