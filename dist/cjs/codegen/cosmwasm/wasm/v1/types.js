...
__export(types_exports, {
  ...
  Cosmwasm_wasmv1ContractInfoExtension_FromAmino: () => Cosmwasm_wasmv1ContractInfoExtension_FromAmino,
  Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder: () => Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder,
  Cosmwasm_wasmv1ContractInfoExtension_ToAmino: () => Cosmwasm_wasmv1ContractInfoExtension_ToAmino,
  Model: () => Model,
  Params: () => Params,
...
const ContractInfo = {
  ...
  encode(message, writer = import_binary.BinaryWriter.create()) {
    ...
    if (message.extension !== void 0) {
      import_any.Any.encode(message.extension, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },
  decode(input, length) {
  ...
  fromPartial(object) {
    ...
    message.extension = object.extension !== void 0 && object.extension !== null ? import_any.Any.fromPartial(object.extension) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseContractInfo();
