...
const QueryVerifyMembershipRequest = {
  ...
  fromPartial(object) {
    ...
    message.proof = object.proof ?? new Uint8Array();
    message.proofHeight = object.proofHeight !== void 0 && object.proofHeight !== null ? Height.fromPartial(object.proofHeight) : void 0;
    message.merklePath = object.merklePath !== void 0 && object.merklePath !== null ? MerklePath.fromPartial(object.merklePath) : void 0;
  ...
  toAmino(message) {
    ...
    obj.proof = message.proof ? base64FromBytes(message.proof) : void 0;
    obj.proof_height = message.proofHeight ? Height.toAmino(message.proofHeight) : {};
    obj.merkle_path = message.merklePath ? MerklePath.toAmino(message.merklePath) : void 0;
