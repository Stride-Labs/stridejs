...
const PeriodicAllowance = {
  ...
  toAmino(message) {
    ...
    obj.period = message.period ? Duration.toAmino(message.period) : void 0;
    ...
    obj.period_reset = message.periodReset ? Timestamp.toAmino(toTimestamp(message.periodReset)) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
