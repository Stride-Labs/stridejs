...
const TableDescriptor = {
  ...
  fromAmino(object) {
    const message = createBaseTableDescriptor();
    if (object.primary_key !== void 0 && object.primary_key !== null) {
  ...
  toAmino(message) {
    const obj = {};
    obj.primary_key = message.primaryKey ? PrimaryKeyDescriptor.toAmino(message.primaryKey) : void 0;
    if (message.index) {
      obj.index = message.index.map((e) => e ? SecondaryIndexDescriptor.toAmino(e) : void 0);
    } else {
...
const PrimaryKeyDescriptor = {
  ...
  fromAmino(object) {
    ...
    if (object.auto_increment !== void 0 && object.auto_increment !== null) {
  ...
  toAmino(message) {
    const obj = {};
    obj.fields = message.fields === "" ? void 0 : message.fields;
    obj.auto_increment = message.autoIncrement === false ? void 0 : message.autoIncrement;
    return obj;
  },
  fromAminoMsg(object) {
...
const SecondaryIndexDescriptor = {
  ...
  fromAmino(object) {
    ...
    if (object.unique !== void 0 && object.unique !== null) {
  ...
  toAmino(message) {
    ...
    obj.fields = message.fields === "" ? void 0 : message.fields;
    obj.id = message.id === 0 ? void 0 : message.id;
    obj.unique = message.unique === false ? void 0 : message.unique;
    return obj;
  },
  fromAminoMsg(object) {
