...
const Params = {
  ...
  fromPartial(object) {
    ...
    message.expeditedVotingPeriod = object.expeditedVotingPeriod !== void 0 && object.expeditedVotingPeriod !== null ? Duration.fromPartial(object.expeditedVotingPeriod) : void 0;
  ...
  toAmino(message) {
    ...
    obj.expedited_voting_period = message.expeditedVotingPeriod ? Duration.toAmino(message.expeditedVotingPeriod) : void 0;
    obj.expedited_threshold = message.expeditedThreshold === "" ? void 0 : message.expeditedThreshold;
    if (message.expeditedMinDeposit) {
      obj.expedited_min_deposit = message.expeditedMinDeposit.map((e) => e ? Coin.toAmino(e) : void 0);
    } else {
