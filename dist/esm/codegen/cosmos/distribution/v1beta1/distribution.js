...
const ValidatorHistoricalRewards = {
  ...
  toAmino(message) {
    ...
    if (message.cumulativeRewardRatio) {
      obj.cumulative_reward_ratio = message.cumulativeRewardRatio.map((e) => e ? DecCoin.toAmino(e) : void 0);
    } else {
...
const FeePool = {
  ...
  toAmino(message) {
    ...
    if (message.communityPool) {
      obj.community_pool = message.communityPool.map((e) => e ? DecCoin.toAmino(e) : void 0);
    } else {
