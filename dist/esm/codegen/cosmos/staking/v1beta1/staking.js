...
const Commission = {
  ...
  toAmino(message) {
    ...
    obj.update_time = message.updateTime ? Timestamp.toAmino(toTimestamp(message.updateTime)) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const Params = {
  ...
  toAmino(message) {
    const obj = {};
    obj.unbonding_time = message.unbondingTime ? Duration.toAmino(message.unbondingTime) : void 0;
