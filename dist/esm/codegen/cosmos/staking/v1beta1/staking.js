...
const CommissionRates = {
  ...
  toAmino(message) {
    const obj = {};
    obj.rate = message.rate === "" ? void 0 : Decimal.fromUserInput(message.rate, 18).atomics;
    obj.max_rate = message.maxRate === "" ? void 0 : Decimal.fromUserInput(message.maxRate, 18).atomics;
    obj.max_change_rate = message.maxChangeRate === "" ? void 0 : Decimal.fromUserInput(message.maxChangeRate, 18).atomics;
    return obj;
  },
  fromAminoMsg(object) {
...
const Params = {
  ...
  toAmino(message) {
    ...
    obj.min_commission_rate = message.minCommissionRate === "" ? void 0 : Decimal.fromUserInput(message.minCommissionRate, 18).atomics;
    return obj;
  },
  fromAminoMsg(object) {
