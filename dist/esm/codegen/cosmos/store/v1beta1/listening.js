...
const BlockMetadata = {
  ...
  fromPartial(object) {
    ...
    message.requestFinalizeBlock = object.requestFinalizeBlock !== void 0 && object.requestFinalizeBlock !== null ? RequestFinalizeBlock.fromPartial(object.requestFinalizeBlock) : void 0;
    message.responseFinalizeBlock = object.responseFinalizeBlock !== void 0 && object.responseFinalizeBlock !== null ? ResponseFinalizeBlock.fromPartial(object.responseFinalizeBlock) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseBlockMetadata();
  ...
  toAmino(message) {
    ...
    obj.request_finalize_block = message.requestFinalizeBlock ? RequestFinalizeBlock.toAmino(message.requestFinalizeBlock) : void 0;
    obj.response_finalize_block = message.responseFinalizeBlock ? ResponseFinalizeBlock.toAmino(message.responseFinalizeBlock) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
