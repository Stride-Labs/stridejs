...
const EventProposalPruned = {
  ...
  fromPartial(object) {
    ...
    message.tallyResult = object.tallyResult !== void 0 && object.tallyResult !== null ? TallyResult.fromPartial(object.tallyResult) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseEventProposalPruned();
  ...
  toAmino(message) {
    ...
    obj.tally_result = message.tallyResult ? TallyResult.toAmino(message.tallyResult) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
