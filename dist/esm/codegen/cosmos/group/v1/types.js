...
const Member = {
  ...
  toAmino(message) {
    ...
    obj.added_at = message.addedAt ? Timestamp.toAmino(toTimestamp(message.addedAt)) : /* @__PURE__ */ new Date();
    return obj;
  },
  fromAminoMsg(object) {
...
const GroupInfo = {
  ...
  toAmino(message) {
    ...
    obj.created_at = message.createdAt ? Timestamp.toAmino(toTimestamp(message.createdAt)) : /* @__PURE__ */ new Date();
    return obj;
  },
  fromAminoMsg(object) {
...
const Proposal = {
  ...
  toAmino(message) {
    ...
    obj.voting_period_end = message.votingPeriodEnd ? Timestamp.toAmino(toTimestamp(message.votingPeriodEnd)) : /* @__PURE__ */ new Date();
