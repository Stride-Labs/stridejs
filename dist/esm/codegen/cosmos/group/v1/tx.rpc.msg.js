...
class MsgClientImpl {
  ...
  createGroup(request) {
    ...
    return promise.then((data2) => MsgCreateGroupResponse.decode(new BinaryReader(data2)));
  }
  updateGroupMembers(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupMembersResponse.decode(new BinaryReader(data2)));
  }
  updateGroupAdmin(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupAdminResponse.decode(new BinaryReader(data2)));
  }
  updateGroupMetadata(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupMetadataResponse.decode(new BinaryReader(data2)));
  }
  createGroupPolicy(request) {
    ...
    return promise.then((data2) => MsgCreateGroupPolicyResponse.decode(new BinaryReader(data2)));
  }
  createGroupWithPolicy(request) {
    ...
    return promise.then((data2) => MsgCreateGroupWithPolicyResponse.decode(new BinaryReader(data2)));
  }
  updateGroupPolicyAdmin(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupPolicyAdminResponse.decode(new BinaryReader(data2)));
  }
  updateGroupPolicyDecisionPolicy(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupPolicyDecisionPolicyResponse.decode(new BinaryReader(data2)));
  }
  updateGroupPolicyMetadata(request) {
    ...
    return promise.then((data2) => MsgUpdateGroupPolicyMetadataResponse.decode(new BinaryReader(data2)));
  }
  ...
  withdrawProposal(request) {
    ...
    return promise.then((data2) => MsgWithdrawProposalResponse.decode(new BinaryReader(data2)));
  }
  vote(request) {
  ...
  leaveGroup(request) {
    ...
    return promise.then((data2) => MsgLeaveGroupResponse.decode(new BinaryReader(data2)));
  }
}
export {
  MsgClientImpl
