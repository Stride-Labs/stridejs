...
const ReinvestCallback = {
  ...
  fromPartial(object) {
    const message = createBaseReinvestCallback();
    message.reinvestAmount = object.reinvestAmount !== void 0 && object.reinvestAmount !== null ? Coin.fromPartial(object.reinvestAmount) : void 0;
    message.hostZoneId = object.hostZoneId ?? "";
    return message;
  },
  fromAmino(object) {
  ...
  toAmino(message) {
    const obj = {};
    obj.reinvest_amount = message.reinvestAmount ? Coin.toAmino(message.reinvestAmount) : void 0;
    obj.host_zone_id = message.hostZoneId === "" ? void 0 : message.hostZoneId;
    return obj;
  },
  fromAminoMsg(object) {
