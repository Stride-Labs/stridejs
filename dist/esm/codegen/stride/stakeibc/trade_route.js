...
const TradeConfig = {
  ...
  toAmino(message) {
    ...
    obj.swap_price = message.swapPrice === "" ? void 0 : Decimal.fromUserInput(message.swapPrice, 18).atomics;
    obj.price_update_timestamp = message.priceUpdateTimestamp !== BigInt(0) ? message.priceUpdateTimestamp?.toString() : void 0;
    obj.max_allowed_swap_loss_rate = message.maxAllowedSwapLossRate === "" ? void 0 : Decimal.fromUserInput(message.maxAllowedSwapLossRate, 18).atomics;
...
const TradeRoute = {
  ...
  fromPartial(object) {
    ...
    message.hostAccount = object.hostAccount !== void 0 && object.hostAccount !== null ? ICAAccount.fromPartial(object.hostAccount) : void 0;
    message.rewardAccount = object.rewardAccount !== void 0 && object.rewardAccount !== null ? ICAAccount.fromPartial(object.rewardAccount) : void 0;
    message.tradeAccount = object.tradeAccount !== void 0 && object.tradeAccount !== null ? ICAAccount.fromPartial(object.tradeAccount) : void 0;
  ...
  toAmino(message) {
    ...
    obj.host_account = message.hostAccount ? ICAAccount.toAmino(message.hostAccount) : void 0;
    obj.reward_account = message.rewardAccount ? ICAAccount.toAmino(message.rewardAccount) : void 0;
    obj.trade_account = message.tradeAccount ? ICAAccount.toAmino(message.tradeAccount) : void 0;
