...
const QueryOracleResponse = {
  ...
  fromPartial(object) {
    const message = createBaseQueryOracleResponse();
    message.oracle = object.oracle !== void 0 && object.oracle !== null ? Oracle.fromPartial(object.oracle) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryOracleResponse();
  ...
  toAmino(message) {
    const obj = {};
    obj.oracle = message.oracle ? Oracle.toAmino(message.oracle) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
