...
const Minter = {
  ...
  toAmino(message) {
    const obj = {};
    obj.epoch_provisions = message.epochProvisions === "" ? void 0 : Decimal.fromUserInput(message.epochProvisions, 18).atomics;
    return obj;
  },
  fromAminoMsg(object) {
...
const DistributionProportions = {
  ...
  toAmino(message) {
    const obj = {};
    obj.staking = message.staking === "" ? void 0 : Decimal.fromUserInput(message.staking, 18).atomics;
    obj.community_pool_growth = message.communityPoolGrowth === "" ? void 0 : Decimal.fromUserInput(message.communityPoolGrowth, 18).atomics;
    obj.community_pool_security_budget = message.communityPoolSecurityBudget === "" ? void 0 : Decimal.fromUserInput(message.communityPoolSecurityBudget, 18).atomics;
    obj.strategic_reserve = message.strategicReserve === "" ? void 0 : Decimal.fromUserInput(message.strategicReserve, 18).atomics;
    return obj;
  },
  fromAminoMsg(object) {
...
const Params = {
  ...
  toAmino(message) {
    ...
    obj.genesis_epoch_provisions = message.genesisEpochProvisions === "" ? void 0 : Decimal.fromUserInput(message.genesisEpochProvisions, 18).atomics;
    ...
    obj.reduction_factor = message.reductionFactor === "" ? void 0 : Decimal.fromUserInput(message.reductionFactor, 18).atomics;
