...
const Query = {
  ...
  fromPartial(object) {
    ...
    message.timeoutDuration = object.timeoutDuration !== void 0 && object.timeoutDuration !== null ? Duration.fromPartial(object.timeoutDuration) : void 0;
  ...
  toAmino(message) {
    ...
    obj.request_data = message.requestData ? base64FromBytes(message.requestData) : void 0;
    ...
    obj.callback_data = message.callbackData ? base64FromBytes(message.callbackData) : void 0;
    obj.timeout_policy = message.timeoutPolicy === 0 ? void 0 : message.timeoutPolicy;
    obj.timeout_duration = message.timeoutDuration ? Duration.toAmino(message.timeoutDuration) : void 0;
