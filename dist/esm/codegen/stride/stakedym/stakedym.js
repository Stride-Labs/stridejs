...
const HostZone = {
  ...
  toAmino(message) {
    ...
    obj.last_redemption_rate = message.lastRedemptionRate === "" ? void 0 : Decimal.fromUserInput(message.lastRedemptionRate, 18).atomics;
    obj.redemption_rate = message.redemptionRate === "" ? void 0 : Decimal.fromUserInput(message.redemptionRate, 18).atomics;
