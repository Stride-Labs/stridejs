import { DelegationRecord, UnbondingRecord, RedemptionRecord } from "./stakedym";
...
const MsgRedeemStakeResponse = {
  ...
  fromPartial(object) {
    const message = createBaseMsgRedeemStakeResponse();
    message.nativeToken = object.nativeToken !== void 0 && object.nativeToken !== null ? Coin.fromPartial(object.nativeToken) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgRedeemStakeResponse();
  ...
  toAmino(message) {
    const obj = {};
    obj.native_token = message.nativeToken ? Coin.toAmino(message.nativeToken) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgOverwriteDelegationRecord = {
  ...
  fromPartial(object) {
    const message = createBaseMsgOverwriteDelegationRecord();
    message.creator = object.creator ?? "";
    message.delegationRecord = object.delegationRecord !== void 0 && object.delegationRecord !== null ? DelegationRecord.fromPartial(object.delegationRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgOverwriteDelegationRecord();
  ...
  toAmino(message) {
    const obj = {};
    obj.creator = message.creator === "" ? void 0 : message.creator;
    obj.delegation_record = message.delegationRecord ? DelegationRecord.toAmino(message.delegationRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgOverwriteUnbondingRecord = {
  ...
  fromPartial(object) {
    const message = createBaseMsgOverwriteUnbondingRecord();
    message.creator = object.creator ?? "";
    message.unbondingRecord = object.unbondingRecord !== void 0 && object.unbondingRecord !== null ? UnbondingRecord.fromPartial(object.unbondingRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgOverwriteUnbondingRecord();
  ...
  toAmino(message) {
    const obj = {};
    obj.creator = message.creator === "" ? void 0 : message.creator;
    obj.unbonding_record = message.unbondingRecord ? UnbondingRecord.toAmino(message.unbondingRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const MsgOverwriteRedemptionRecord = {
  ...
  fromPartial(object) {
    const message = createBaseMsgOverwriteRedemptionRecord();
    message.creator = object.creator ?? "";
    message.redemptionRecord = object.redemptionRecord !== void 0 && object.redemptionRecord !== null ? RedemptionRecord.fromPartial(object.redemptionRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseMsgOverwriteRedemptionRecord();
