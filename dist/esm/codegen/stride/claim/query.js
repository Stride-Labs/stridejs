...
const ClaimMetadata = {
  ...
  toAmino(message) {
    ...
    obj.current_round_start = message.currentRoundStart ? Timestamp.toAmino(toTimestamp(message.currentRoundStart)) : void 0;
    obj.current_round_end = message.currentRoundEnd ? Timestamp.toAmino(toTimestamp(message.currentRoundEnd)) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryDistributorAccountBalanceResponse = {
  ...
  toAmino(message) {
    ...
    if (message.distributorAccountBalance) {
      obj.distributor_account_balance = message.distributorAccountBalance.map((e) => e ? Coin.toAmino(e) : void 0);
    } else {
...
const QueryClaimRecordResponse = {
  ...
  fromPartial(object) {
    const message = createBaseQueryClaimRecordResponse();
    message.claimRecord = object.claimRecord !== void 0 && object.claimRecord !== null ? ClaimRecord.fromPartial(object.claimRecord) : void 0;
    return message;
  },
  fromAmino(object) {
    const message = createBaseQueryClaimRecordResponse();
  ...
  toAmino(message) {
    const obj = {};
    obj.claim_record = message.claimRecord ? ClaimRecord.toAmino(message.claimRecord) : void 0;
    return obj;
  },
  fromAminoMsg(object) {
...
const QueryUserVestingsResponse = {
  ...
  toAmino(message) {
    ...
    if (message.spendableCoins) {
      obj.spendable_coins = message.spendableCoins.map((e) => e ? Coin.toAmino(e) : void 0);
    } else {
      obj.spendable_coins = message.spendableCoins;
    }
    if (message.periods) {
      obj.periods = message.periods.map((e) => e ? Period.toAmino(e) : void 0);
    } else {
